...
- **已实现**：`singleton`、`factory_method`、`abstract_factory`、`builder`、`prototype`、`adapter`、`decorator`、`proxy`、`facade`、`composite`、`bridge`、`flyweight`、`strategy`、`observer` 是贴近真实场景的客户端。
